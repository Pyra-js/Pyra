    ...
    <div style={{ fontFamily: 'system-ui, -apple-system, sans-serif', maxWidth: '800px', margin: '0 auto' }}>
      <header style={{ padding: '1rem 0', borderBottom: '2px solid #e5e7eb' }}>
        <nav style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
          <Link href="/" style={{ fontSize: '1.25rem', fontWeight: 'bold', textDecoration: 'none', color: '#ef4444' }}>
            Pyra Blog
          </Link>
          <Link href="/blog" style={{ textDecoration: 'none', color: '#6b7280' }}>Blog</Link>
          <Link href="/about" style={{ textDecoration: 'none', color: '#6b7280' }}>About</Link>
          <Link href="/dashboard" style={{ textDecoration: 'none', color: '#6b7280', marginLeft: 'auto' }}>Dashboard</Link>
        </nav>
      </header>
